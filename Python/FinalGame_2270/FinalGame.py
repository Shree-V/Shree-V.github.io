...
icon = pygame.image.load("shoal.png")
...
fishImage1 = pygame.image.load("orange-fish.png")
fishImage2 = pygame.image.load("fish.png")
...
# Background
background = pygame.transform.scale(pygame.image.load('background-houses.jpg').convert(), (windowHeight, windowHeight))
